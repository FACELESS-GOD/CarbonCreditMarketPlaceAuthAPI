...
type LoginUserResponse struct {
	...
	RefereshToken          string                 `protobuf:"bytes,4,opt,name=referesh_token,json=refereshToken,proto3" json:"referesh_token,omitempty"`
	...
	RefereshTokenExpiresAt *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=referesh_token_expires_at,json=refereshTokenExpiresAt,proto3" json:"referesh_token_expires_at,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *LoginUserResponse) GetRefereshToken() string {
	if x != nil {
...
func (x *LoginUserResponse) GetRefereshTokenExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.RefereshTokenExpiresAt
	}
	return nil
}
...
const file_rpc_login_user_proto_rawDesc = "" +
	...
	"\x0ereferesh_token\x18\x04 \x01(\tR\rrefereshToken\x12Q\n" +
	"\x17access_token_expires_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x14accessTokenExpiresAt\x12U\n" +
	"\x19referesh_token_expires_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x16refereshTokenExpiresAtB#Z!CarbonCreditMarketPlaceAuthAPI/pbb\x06proto3"
...
var file_rpc_login_user_proto_depIdxs = []int32{
	...
	2, // 1: pb.LoginUserResponse.referesh_token_expires_at:type_name -> google.protobuf.Timestamp
